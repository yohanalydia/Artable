...
<html lang="id">
    <head>
        <meta charset="UTF-8">
        <title>Edit Seniman - Artable</title>
    ...
    <body>
        ...
        <%
            // Ambil data seniman yang dikirim dari Servlet
        ...
        <!-- BAGIAN EDIT SENIMAN YANG DIMILIKI OLEH USER SEKOLAH -->
                    ...
                    <div class="card card-custom p-4">
                        ...
                        <form action="SenimanServlet?action=update" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 text-center">
                                <label class="form-label d-block small fw-bold">Foto Profil Saat Ini</label>
                                <img src="<%= s.getImageUrl()%>" class="current-img" alt="Foto Seniman">
                                <input type="file" name="foto" class="form-control mt-2">
                                <div class="form-text text-muted small">Kosongkan jika tidak ingin mengganti foto.</div>
                            </div>

                            <div class="mb-3">
                                <label class="form-label small fw-bold">Nama Lengkap</label>
                                <input type="text" name="nama" class="form-control" value="<%= s.getNama()%>" required>
                            </div>

                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label small fw-bold">Tanggal Lahir</label>
                                    <input type="date" name="tanggalLahir" class="form-control" value="<%= s.getTanggalLahir()%>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label small fw-bold">Jenis Kelamin</label>
                                    <select name="jenisKelamin" class="form-select">
                                        <option value="Laki-laki" <%= "Laki-laki".equals(s.getJenisKelamin()) ? "selected" : ""%>>Laki-laki</option>
                                        <option value="Perempuan" <%= "Perempuan".equals(s.getJenisKelamin()) ? "selected" : ""%>>Perempuan</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="jenisDisabilitas" class="form-control" value="<%= s.getJenisDisabilitas()%>" required>
                            </div>

                            <div class="mb-4">
                                <label class="form-label small fw-bold">Tentang Seniman</label>
                                <textarea name="tentangSaya" class="form-control" rows="4" required><%= s.getTentangSaya()%></textarea>
                            </div>
